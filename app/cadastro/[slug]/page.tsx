          ...
          <div>
            ...
            <ul className="text-[11px] text-gray-600 space-y-2 mt-3">
              ...
              <li className="flex gap-2 items-center">
                ...
                Um caracter especial (exemplo: @ ! $ & #)
              </li>
            </ul>
          </div>

          <button className="w-full h-[42px] rounded-full bg-[#f28000] hover:bg-orange-600 text-white font-medium py-2 transition mt-2">
            Cadastrar
          </button>
        </form>
        <hr className="my-7 border-[#cfd4dd]" />
        <div className="flex justify-center items-center gap-4">
          <span>Já tem uma conta?</span>
          <a
            href=""
            className="text-[#6e0ad6] rounded-full text-semibold text-sm py-2 px-3 duration-300 hover:bg-[#f0e6ff]"
          >
            Entrar
          </a>
        </div>
